...
void Window::init()
{
	...
	Shader *vert = ShaderManager::instance()->loadFromFile("Vertex", kShaderTypeVertex, "/Users/adilsontavares/GitHub/opengl-engine/Shaders/simple.vs");
	Shader *frag = ShaderManager::instance()->loadFromFile("Fragment", kShaderTypeFragment, "/Users/adilsontavares/GitHub/opengl-engine/Shaders/simple.fs");
